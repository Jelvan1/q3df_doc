...
0 & 0 & 0\\
\end{pmatrix},\\
%&&&= \frac{\vec{\flat{v}}_f \vec{\flat{v}}_f^T}{\vec{\flat{v}}_f^T \vec{\flat{v}}_f} &&= \frac{\resprojmat{\flat{n}}\vec{v}_f\vec{v}_f^T\resprojmat{\flat{n}}^T}{\vec{v}_f^T\resprojmat{\flat{n}}\vec{v}_f} &&= \projmat{\flat{v}_f}^T = \projmat{\flat{v}_f}^k, \qquad k \in \mathbb{N}^+,\\
%
