...
\begin{itemize}
	...
	\color{cgazgrey!50}\item\color{black} $\delta \in [0, \delta_{\min})$\\
	The no-acceleration zone.
	\color{cgazgreen!50}\item\color{black} $\delta \in [\delta_{\min}, \delta_{\opt})$\\
	...
	\color{cgazdarkgreen!50}\item\color{black} $\delta \in [\delta_{\opt}, \bar{\delta}_{\max})$\\
	...
	\color{cgazyellow!50}\item\color{black} $\delta \in [\bar{\delta}_{\max}, \delta_{\max}]$\\
